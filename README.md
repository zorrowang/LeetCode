...
|255|[Verify Preorder Sequence in Binary Search Tree](https://leetcode.com/problems/verify-preorder-sequence-in-binary-search-tree)|[Java](./src/java/medium/tree/VerifyPreorderSequenceBinarySearchTree.java)| DFS | LintCode [1307](https://www.lintcode.com/problem/verify-preorder-sequence-in-binary-search-tree/description) |
